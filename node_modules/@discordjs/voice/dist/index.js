...
var import_davey = __toESM(require("@snazzah/davey"));
...
function getMaxProtocolVersion() {
  return import_davey.default.DAVE_PROTOCOL_VERSION;
}
...
var DAVESession = class extends import_node_events2.EventEmitter {
  ...
  reinit() {
    if (this.protocolVersion > 0) {
      if (this.session) {
        ...
        this.session = new import_davey.default.DAVESession(this.protocolVersion, this.userId, this.channelId);
  ...
  decrypt(packet, userId) {
    ...
    try {
      const buffer = this.session.decrypt(userId, import_davey.default.MediaType.AUDIO, packet);
      this.consecutiveFailures = 0;
      return buffer;
    } catch (error) {
...
var AudioReceiveStream = class extends import_node_stream.Readable {
  ...
  push(buffer) {
    ...
    if (buffer === null) {
      import_node_process.default.nextTick(() => this.destroy());
    }
...
function version(name) {
  try {
    if (name === "@discordjs/voice") {
      return "1.0.0-dev.1772884937-84b85f4c9";
    }
...
// src/index.ts
var version2 = "1.0.0-dev.1772884937-84b85f4c9";
